...
def get_input():
    ...
    print('\n')
    print('**  HOW TO USE BRIEFIT **\n')
    print('**  START **\n')
    print('**  STEP 1: USER SELECT TEXT(T) OR FILE PATH(F) OR URL(U) **\n')
    print('**  STEP 2: USER INPUT/PASTE TEXT OR FILE PATH OR URL **\n')
    print('**  STEP 3: USER SELECT (S) FOR SHORT SUMMARY OR (L) FOR LONG SUMMARY **\n')
    print('**  STEP 4: USER CHOOSE WHETHER THEY WANT TO DOWNLOAD A COPY OF THE SUMMARY IN .TXT **\n')
